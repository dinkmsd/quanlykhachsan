<div class="wrapper">
    ...
    <div class="formRow">
     ...
     <div class="formRow">
    	...
    	<div class="formRight">
    		<span class="oneTwo"><input name="email" id="param_name" value="<?php echo set_value("email") ?>" _autocheck="true" type="text"></span>
    ...
    <div class="formRow">
    	...
    	<div class="formRight">
    		<span class="oneTwo"><textarea rows="3" cols="20" name="diachi" id="param_name" value="" _autocheck="true" type="text"><?php echo set_value("diachi") ?></textarea></span>
