...
<center>
	...
	<div style="width:550px; text-align:left; height:20px;">{#total_vote#} : {$totalVote|default:0}</div>
	<table width="550" border="1" bordercolor="#666666" style=" border-collapse:collapse;text-align:left; font-size:11px;">
	  <tr>
		...
		<tr>
			...
			<td width="400" style="padding:5px;"><span style=" float:left; margin-right:5px;width:{$answer.width+2}px; background-color:#6699FF; border:1px solid #333333">&nbsp;</span><span style="color:#FF0000">{$answer.percent|default:0}% - {$answer.Vote_Number} {#vote#}</span></td>
		</tr>
		 {/foreach}
	</table><br />
